...
{
    using mobiflight::devices;
    bool Config::readConfigLength()
    {
        char     temp       = 0;
    ...
    void Config::OnResetConfig()
    {
        resetConfig();
        cmdMessenger.sendCmd(kStatus, F("OK"));
    }

    void Config::OnSaveConfig()
    {
